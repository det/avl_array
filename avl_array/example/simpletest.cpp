...
/*
    AVL Array 1.1 performance test
    ...
    AVL Arrays outperform vector and list UNDER VERY PARTICULAR
    CONDITIONS. AVL Arrays are the best choice in cases where
...
int main ()
{
  ...
  srand (seed);
  test (avl_array<unsigned>(),
        avl_array<unsigned>::iterator(),
        "avl_array<unsigned>");
